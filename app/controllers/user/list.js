...
new utilities.express.Service(tagLabel)
    ...
    .controller(async (req, res) => {
        ...
        if(moment(date).isValid())
            queries.push({$or:[{createdAt:{$lte:moment(date, 'MM-DD-YYYY').endOf('day'), $gte:moment(date, 'MM-DD-YYYY').startOf('day')}}, {updatedAt:{$lte:moment(date, 'MM-DD-YYYY').endOf('day'), $gte:moment(date, 'MM-DD-YYYY').startOf('day')}}]});
